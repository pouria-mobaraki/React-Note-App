...
export default class NoteApp extends Component {
    ...
    this.setState(prevState=>{
        return {notes : [...prevState.notes, newNoteObject],
                inputColor:'#fff',
                noteTitle:''
                ...
                <div>
                    <section id="home">
                        <div className="container">
                            <div className="header upper">Pouria Note App</div>
                            ...
                            <div className="flex row-gt-sm">
                                <div className="flex flex-50-gt-sm">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto my-1 text-right">
                                        ...
                                        <button id="btn-delete" type="button" className="btn btn-outline-danger" onClick={this.emptyNoteTitle}><span id="btn-icon"
